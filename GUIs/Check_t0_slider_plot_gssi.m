function [] = Check_t0_slider_plot_gssi(foldername,name,profilelist,UTMzone)
...
[S.traces,S.dt,S.ns,S.x,S.y,S.z]=readGSSI(S.foldername,UTMzone,S.profiles(1));
...
S.fh.Visible='on';
    ...
    function S=addcomponents(S)
        ...
        grid on
        set(S.ax3,'YLim',[0 20],'XTick',[0],'XTickLabel',[])
...
%%% Callback functions:
    ...
    function [] = ref_call(varargin)
        ...
        temp=readGSSI(S.foldername,UTMzone,S.profiles(1));
    ...
    function [] = plotnew_call(varargin)
        ...
        elseif S.method==2  % channelshift for all profiles the same
            ...
            [refprof,S.dt,S.ns,S.x,S.y,S.z]=readGSSI(S.foldername,UTMzone,S.profiles(1));
