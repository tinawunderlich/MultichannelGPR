function [zout,xgrid,ygrid] = bindata3_oneTracePerBin(z,x,y,xrg,yrg)

% [zout] = bindata3_oneTracePerBin(z,x,y,xrg,yrg)
%
...
% it to all time-sample-slices. It just puts the first trace in each bin in
% it (no averaging!)
